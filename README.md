...
|--------|-------------|------|
| [Foundational Economy Toolkit](https://github.com/Varavallo/foundational-economy-toolkit) | Data-driven framework to map foundational service provision in marginal municipalities using the Google Maps Places API. Foundational Economy Index (FEI) validated against ISTAT ASIA register. Paper under review. | Python · GeoPandas · PySAL · Google Maps API · QGIS |
